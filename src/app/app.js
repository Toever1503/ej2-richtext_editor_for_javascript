...
define(["require", "exports", "@syncfusion/ej2-richtexteditor", "@syncfusion/ej2-base"], function (require, exports, ej2_richtexteditor_1, ej2_base_1) {
    ...
    window.initRichtextEditor = function (eLementId, options) {
        ...
        var defaultRTE = new (ej2_richtexteditor_1.RichTextEditor.bind.apply(ej2_richtexteditor_1.RichTextEditor, __spreadArray([void 0, richtextConfigure], options, false)))();
